<?php
    ...
    if (!empty($_POST)) {
        ...
        $sql = "DELETE FROM GRAAL.dbo.Compte WHERE Matricule = ?";
        $params = array($mat);
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Supprimer un compte GRAAL</h1>
        ...
        <br>
        <br>
        <form class="form" action="dropGraal.php" method="post">
                <input type="hidden" name="mat" value="<?php echo $mat;?>"/>
                <p class="alert alert-warning">Etes vous sur de vouloir supprimer ?</p>
                <div class="form-actions">
                    <button type="submit" class="btn btn-outline-success">Oui</button>
                    <a class="btn btn-outline-danger" href="<?php echo 'viewGraal.php?mat='.$mat;?>">Non</a>
                </div>
            </form>
      </main>
    </div>
